...
const UserLogin = (props) => {
    ...
    return (
        <Section>
            ...
            <Columns>
                <Columns.Column>
                    <form data-cy="loginForm" onSubmit={(event) => handleLogin(event, props)}>
                        {loginError && <p className="has-text-danger">{loginError}</p>}
                        <label className="label" style={styles.padding}>Username</label>
                        <input type="text" data-cy="username" className="input" name="username" placeholder="Username" required></input>
                        <label className="label" style={styles.padding}>Password</label>
                        <input type="password" data-cy="password" className="input" name="password" placeholder="Password" required></input>
                        <input type="submit" data-cy="loginButton" value="Login" className="button is-info" style={styles.padding}></input>
                    </form>
                </Columns.Column>
                <Columns.Column>
